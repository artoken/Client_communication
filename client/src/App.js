            ...
            <div className="col-sm-5 col-md-3" style={{" text-align": "left"}}>
              ...
              <div class="card" style={{"padding": "15px", "margin": "15px"}}>
                <form onSubmit={(e) => {
                            ...
                            <button type='submit' style={{"border-radius":"50px","margin-left":"0px","margin-right":"0px","margin-top":"0px","background-color": "#B22222","border": "solid 1px #B22222"}} className='btn btn-primary mb-2'><i class="far fa-check-circle"></i></button>
                              <h3  style={{"border-radius":"50px","margin":"10px"}}><strong> allow</strong></h3>
                             </div>
                          <div class="row" style={{"padding": "10px"}} >
                              <div class="col-sm-10 col-md-10" >
                                      <div className='form-group mr-sm-2' style={{"max-width":"80%"}}>
                                          <input
                                            ...
                                            id='shareID_ALLOW'
                                            type='unit'
                                            ref={(input) => { this.shareID_ALLOW = input }}
                                            className="form-control  mt-2"
...
<div class="card" style={{"padding": "15px", "margin": "15px"}}>
  <form onSubmit={(e) => {
              ...
              <div class="row" style={{"padding": "10px"}}>
              <button type='submit' style={{"border-radius":"50px","margin-left":"0px","margin-right":"0px","margin-top":"0px","background-color": "#B22222","border": "solid 1px #B22222"}} className='btn btn-primary mb-2'><i class="fas fa-user"></i></button>
                <h3  style={{"border-radius":"50px","margin":"10px"}}><strong> owner_of</strong></h3>
               </div>
            <div class="row" style={{"padding": "10px"}} >
                <div class="col-sm-10 col-md-10" >
                        <div className='form-group mr-sm-2' style={{"max-width":"80%"}}>
                            <input
                              id='shareID_Owner'
                              type='unit'
                              ref={(input) => { this.shareID_Owner = input }}
                              className="form-control mt-2"
                              placeholder='_share_id'
                              required />
                         </div>
...
<div class="card" style={{"padding": "15px", "margin": "15px"}}>
  <form onSubmit={(e) => {
              ...
              <div class="row" style={{"padding": "10px"}}>
              <button type='submit' style={{"border-radius":"50px","margin-left":"0px","margin-right":"0px","margin-top":"0px","background-color": "#B22222","border": "solid 1px #B22222"}} className='btn btn-primary mb-2'><i class="fas fa-search"></i></button>
                <h3  style={{"border-radius":"50px","margin":"10px"}}><strong> get_art_by_id</strong></h3>
               </div>
            <div class="row" style={{"padding": "10px"}} >
                <div class="col-sm-10 col-md-10" >
                        <div className='form-group mr-sm-2' style={{"max-width":"80%"}}>
...
<div class="card" style={{"padding": "15px", "margin": "15px"}}>
  <form onSubmit={(e) => {
              ...
              <div class="row" style={{"padding": "10px"}}>
              <button type='submit'style={{"border-radius":"50px","margin-left":"0px","margin-right":"0px","margin-top":"0px","background-color": "#B22222","border": "solid 1px #B22222"}} className='btn btn-primary mb-2'><i class="fas fa-exchange-alt"></i></button>
                <h3  style={{"border-radius":"50px","margin":"10px"}}><strong> transferFrom</strong></h3>
               </div>
            <div class="row" style={{"padding": "10px"}} >
                <div class="col-sm-10 col-md-10" >
                        <div className='form-group mr-sm-2' style={{"max-width":"80%"}}>
                            <input
                              id='from_transfer'
                              type='string'
                              ref={(input) => { this.from_transfer = input }}
                              className="form-control mt-2"
                              placeholder='_from'
                              required />
                              <input
                              id='TO_TRANSFER'
                              type='string'
                              ref={(input) => { this.TO_TRANSFER = input }}
                              className="form-control mt-2"
                              placeholder='_to'
                              required />
                              <input
...
<div class="card" style={{"padding": "15px", "margin": "15px"}}>
  <form onSubmit={(e) => {
              ...
              <div class="row" style={{"padding": "10px"}}>
              <button type='submit' style={{"border-radius":"50px","margin-left":"0px","margin-right":"0px","margin-top":"0px","background-color": "#B22222","border": "solid 1px #B22222"}} className='btn btn-primary mb-2'><i class="far fa-handshake"></i></button>
                <h3 style={{"border-radius":"50px","margin":"10px"}}><strong> endow_share</strong></h3>
               </div>
            <div class="row" style={{"padding": "10px"}} >
                <div class="col-sm-10 col-md-10" >
                        <div className='form-group mr-sm-2' style={{"max-width":"80%"}}>
                            <input
                              id='FROM_ENDOW'
                              type='string'
                              ref={(input) => { this.FROM_ENDOW = input }}
                              className="form-control mt-2"
                              placeholder='_from'
                              required />
                              <input
                              ...
                              id='shareID_ENDOW'
                              type='unit'
                              ref={(input) => { this.shareID_ENDOW = input }}
                              className="form-control  mt-2"
                              placeholder='_share_id'
                              required />
                              <input
...
<div class="card" style={{"padding": "15px", "margin": "15px"}}>
  <form onSubmit={(e) => {
              ...
              <div class="row" style={{"padding": "10px"}}>
              <button type='submit' style={{"border-radius":"50px","margin-top":"10px","background-color": "#B22222","border": "solid 1px #B22222"}} className='btn btn-primary mb-2'><i class="fab fa-elementor"></i></button>
                <h3 style={{"border-radius":"50px","margin":"10px"}}><strong>Withdraw</strong></h3>
               </div>
            <div class="row" style={{"padding": "10px"}} >
                <div class="col-sm-10 col-md-10" >
                        <div className='form-group mr-sm-2' style={{"max-width":"80%"}}>
                            <input
                              id='ADDRESS_CONTRACT'
                              type='string'
                              ref={(input) => { this.ADDRESS_CONTRACT = input }}
                              className="form-control mt-2"
...
<div class="card" style={{"padding": "15px", "margin": "15px"}}>
  <form onSubmit={(e) => {
              ...
              <div class="row" style={{"padding": "10px"}}>
              <button type='submit' style={{"border-radius":"50px","margin-top":"10px","background-color": "#B22222","border": "solid 1px #B22222"}} className='btn btn-primary mb-2'><i class="fab fa-elementor"></i></button>
                <h3 style={{"border-radius":"50px","margin":"10px"}}><strong>get_share</strong></h3>
               </div>
            <div class="row" style={{"padding": "10px"}} >
                <div class="col-sm-10 col-md-10" >
                        <div className='form-group mr-sm-2' style={{"max-width":"80%"}}>
                            <input
                              id='FROM_GET_SHARE'
                              type='string'
                              ref={(input) => { this.FROM_GET_SHARE = input }}
                              className="form-control mt-2"
                              placeholder='_from'
                              required />
							  <input
                              id='TOKEN_ID_SHARE'
                              type='string'
                              ref={(input) => { this.TOKEN_ID_SHARE = input }}
                              className="form-control mt-2"
